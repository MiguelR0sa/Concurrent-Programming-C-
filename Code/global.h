...
//semaphore macros
#define ACCESS              0
#define FREE_CLIENT_BENCHES   1
#define CLIENTS_SEATED        2
#define FREE_BARBERS         3
#define FREE_WASHBASINS      4
////////////////////////////////////////////////
...
#define SCISSOR              string_concat(NULL, 0, code2utf8(NULL, get_code_utf8((char*)"SCISSOR")), (char*)" ", NULL)
